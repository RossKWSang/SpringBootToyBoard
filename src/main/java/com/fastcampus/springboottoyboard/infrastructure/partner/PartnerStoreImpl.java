...
import com.fastcampus.springboottoyboard.common.exception.InvalidParamException;
import com.fastcampus.springboottoyboard.domain.partner.Partner;
import com.fastcampus.springboottoyboard.domain.partner.PartnerStore;
...
public class PartnerStoreImpl implements PartnerStore {
    ...
    public Partner store(Partner partner) {
        ...
        if (StringUtils.isEmpty(partner.getBusinessNumber())) throw new InvalidParamException("partner.getBusinessNo()");
